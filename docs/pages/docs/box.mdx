...
using the inline style in the props, using the `sx` prop which receives an
object, or with component `variants`.

## Style Properties

Similarly [Styled System](https://styled-system.com/) but adapted to React Native specifications.
